...
"}")
        ...
        self.btn_add = QtWidgets.QPushButton(self.tab_plot)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_param.setText(_translate("Form", "Wave Shift"))
        self.btn_normalise.setText(_translate("Form", "Normalise"))
        self.tab_widget_main.setTabText(self.tab_widget_main.indexOf(self.tab_normalise), _translate("Form", "Normalise Data"))
        self.btn_add.setText(_translate("Form", "Import"))
